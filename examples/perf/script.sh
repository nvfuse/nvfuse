...
do
	...
	if [ $workload = read ] ; then 
	    ...
	    sudo ./perf -t spdk -d 01:00 -f -m -S $((file_size*1024)) -B $((128*1024)) -E libaio -Q $qdepth -D -T ${RUNTIME} | tee ${OUTPUT_PATH}/128K_read_${qdepth}_qdepth_${file_size}G_seq.log
	    ...
	    sudo ./perf -t spdk -d 01:00 -f -m -S $((file_size*1024)) -B $((128*1024)) -E libaio -Q $qdepth -D -W  -T ${RUNTIME} | tee ${OUTPUT_PATH}/128K_write_${qdepth}_qdepth_${file_size}G_seq.log
	    ...
	    sudo ./perf -t spdk -d 01:00 -f -m -S $((file_size*1024)) -B 4096 -E libaio -Q $qdepth -R -D  -T ${RUNTIME}  | tee ${OUTPUT_PATH}/4K_read_${qdepth}_qdepth_${file_size}G_random.log
	    ...
	    sudo ./perf -t spdk -d 01:00 -f -m -S $((file_size*1024)) -B 4096 -E libaio -Q $qdepth -R -D -W -T ${RUNTIME}  | tee ${OUTPUT_PATH}/4K_write_${qdepth}_qdepth_${file_size}G_random.log
	fi
    done
done
